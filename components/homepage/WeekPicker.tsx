  ...
  return (
    <div className='relative mb-5'>
      ...
      <AnimatePresence>
        {isOpen ? (
          <m.div
            key='week-picker-calendar'
            variants={panelIn}
            initial='hidden'
            animate='visible'
            exit='hidden'
            className='absolute left-0 top-[76px] z-30 w-full overflow-hidden rounded-[28px] border-2 border-cosmo-black/10 bg-cosmo-white shadow-[6px_7px_0_0_rgba(0,0,0,0.10)] sm:w-[380px]'>
